    ...
    return (
      ...
      >
        ...
        {data.image ? (
          ...
          <div className="flex-1 w-full bg-[#161622] flex flex-col items-center justify-center border-b border-white/5 relative overflow-hidden group/logo">
            ...
            <img 
              src="/nxs_logo.png" 
              alt="NexSpace" 
              className="w-32 h-32 md:w-40 md:h-40 object-contain opacity-30 grayscale group-hover/logo:scale-110 group-hover/logo:opacity-50 transition-all duration-500 relative z-10" 
            />
          </div>
        )}
